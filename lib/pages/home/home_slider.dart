...
class _HomeSliderState extends State<HomeSlider> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        GetBuilder<ItemListController>(builder: (itemlist) {
          this.totalPage = itemlist.itemList.length;
          return Container(
            ...
            child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildPageItem(index, itemlist.itemList[index]);
                }),
          );
        }),
        // DotsIndicator(
                              ...
                              boxShadow: [
                                ...
                                BoxShadow(
                                  ...
                                  offset: Offset(
                                      0,
                                      Dimensions
                                          .height5), // changes position of shadow
                                ),
                                BoxShadow(
                                  color: AppColors.lightGrey,
                                  spreadRadius: 1,
  ...
  Widget _buildPageItem(index, ItemModel item) {
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    blurRadius: Dimensions.radius5,
                    offset: Offset(
                        0, Dimensions.height5), // changes position of shadow
                  ),
                  BoxShadow(
                    color: AppColors.white,
                    offset: Offset(-Dimensions.width5, 0),
